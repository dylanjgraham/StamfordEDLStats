...
ToDo <br>
  ...
  When stats are saved to the json it needs to also pull A division. Right now it is only pulling B and C ✔️ <br>
  add toggle option for light and darkmode ✔️ <br>
